...
import org.kae.ustax4s.federal.Regime.TCJA
...
// TODO:
//   - simplify avoiding the FUTURE variants
//   - agi
//   - various slopes
//   - trumpSeniorDeduction
//   - net deduction
//   - function to populate a range with all result fields

object Facade2:
  import Conversions.given
  import TypeAliases.*
  private val TheRegime = TCJA

  /** Standard deduction for a future year. Example: TF_STD_DEDUCTION(3%, 2030,
  ...
  def tf_ltcg_tax_start(
    ...
    val bracketInflationFactor = 1.0 + bracketInflationRate
    BoundRegime
      .forFutureYear(TheRegime, year, bracketInflationFactor, filingStatus)
      .qualifiedBrackets
  ...
  /** The Federal tax due for a future year. Example: TF_FEDERAL_TAX_DUE(3%, 2023,
  ...
  /** The Federal tax due for a future year. Example: TF_NET_DEDUCTION(0.34, 2023,
    * "Single", 1955-10-02, 0, 10000, 40000, 5000, 0)
    *
    * @param {number} bracketInflationRate estimate of future tax bracket inflation, e.g. 2%
    * @param {number} year a year in the future, after the current year
